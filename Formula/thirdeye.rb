class Thirdeye < Formula
  ...
  url "https://files.pythonhosted.org/packages/source/t/thrdi/thrdi-0.0.10rc1.tar.gz"
  sha256 "1d27544f97e7613416931fa418da5534299f0cf9722dfae28c8d3fd2c2a8164c"
  license "MIT"
  ...
  test do
    ...
    # The `ui` command requires starlette/uvicorn/jinja2 — its presence in
    # `--help` confirms the UI extras were installed by virtualenv_install.
